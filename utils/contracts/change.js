...
const getGasEstimates = async (
  ...
  const gasEstimate = Number(
    await forwarder.estimateGas.changeRecovery(
      forwardRequest,
...
const verifyChangeRecoveryPayload = async (
  forwardRequest,
  forwarder,
  currentChain
) => {
  const constructedMessage = {
    ...
    newRecoveryHash: forwardRequest.newRecoveryHash,
    newRecoveryVerifier: forwardRequest.newRecoveryVerifier,
